...
namespace test_hla_1516_policy_simple_data {
...
namespace t4 {
    ...
    struct SimpleHLAinteger32LE : simple< HLAinteger32LE > { PROTOX_SIMPLE(SimpleHLAinteger32LE) };
}
...
namespace t5 {
    ...
    struct SimpleHLAinteger64LE : simple< HLAinteger64LE > { PROTOX_SIMPLE(SimpleHLAinteger64LE) };
}
...
namespace t6 {
    ...
    struct SimpleHLAfloat32LE   : simple< HLAfloat32LE   > { PROTOX_SIMPLE(SimpleHLAfloat32LE  ) };
    struct SimpleHLAinteger32BE : simple< HLAinteger32BE > { PROTOX_SIMPLE(SimpleHLAinteger32BE) };
}
...
namespace t7 {
    ...
    struct SimpleHLAfloat64LE : simple< HLAfloat64LE > { PROTOX_SIMPLE(SimpleHLAfloat64LE) };
}
