...
/**
 * A type generator for simple datatypes. A simple datatype is a scaler defined by a basic data representation and an optional
 * unit definition.
 *
...
public:
     ...
     */
    simple(typename T::value_type v) :
            T(v) {
    }
