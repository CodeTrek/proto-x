...
/// \cond
typedef boost::mpl::shift_left<boost::mpl::int_<1>, boost::mpl::int_<PROTOX_DTL_POW_2_MAX_BIT_SIZE - 3> >::type MAX_ITERATIONS;
/// \endcond
...
public:
    typedef typename boost::mpl::if_<boost::mpl::greater_equal<product, boost::mpl::int_<S> >, nth_power_of_two, // true  : answer found
