...
#ifndef PROTOX_OM_RPR_REQUEST_STATUS_ENUM32_HPP
#define PROTOX_OM_RPR_REQUEST_STATUS_ENUM32_HPP
...
//      +---------------------+----------------------------------------------------------+-------------------------------+--------+
namespace RequestStatusEnum32 { PROTOX_ENUM_TYPE(HLA13unsigned_long, hla_13::enumerated) ;
                                                                        ...
                                                                        PROTOX_ENUM_VALUE( TACCSF_LOS_Reply_Type1,           100 );
                                                                        PROTOX_ENUM_VALUE( TACCSF_LOS_Reply_Type2,           101 );
                                                                        PROTOX_ENUM_VALUE( Join_Exercise_Request_Rejected,   201 );
//      +--------------------------------------------------------------------------------+-------------------------------+--------+
