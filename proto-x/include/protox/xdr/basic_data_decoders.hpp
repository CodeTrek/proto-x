...
#ifndef PROTOX_XDR_BASIC_DATA_DECODERS_HPP
#define PROTOX_XDR_BASIC_DATA_DECODERS_HPP
...
{
  static inline void unpack( Opaque::value_type *value, const S &s, std::size_t &offset )
  {
