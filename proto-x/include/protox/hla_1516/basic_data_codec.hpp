...
struct basic_codec_impl_1516
{
  ...
  {
    BOOST_STATIC_ASSERT(( boost::mpl::sizeof_< hla_1516::HLAoctet::value_type >::value == 1 ));

    const hla_1516::HLAoctet::value_type
  ...
  inline static void decode( T &v, const S &s, std::size_t &offset )
  {
    ...
    hla_1516::HLAoctet::value_type *v_ptr = (hla_1516::HLAoctet::value_type *)( &v.value );
