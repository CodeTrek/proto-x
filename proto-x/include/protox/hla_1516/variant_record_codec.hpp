...
struct layout_
{
  ...
  static void encode(S &s, R const &obj)
  {
    ...
    {
      typename D::alternative::value_type const *value
        = obj.template alt_< D >();
...
{
  // C++ does not allow full template specialiation within a non-namespace
  // container. Add  an extra template parameter to prevent the need for full
  // specialization. The extra paramater is ignored.
