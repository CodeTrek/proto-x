...
/**
 * Implementers of encode/decode functionality must define the set of \c CODEC_TAG tags
 * and their associated \c codec_impl implementations. The \c CODEC_TAG types are used
 * to dispatch to the correct \c codec_impl implementation.
 *
