...
template<
  typename T,             // T The basic type used to represent the simple type
                          //   being defined.
  typename U = unitless > // U The simple type's unit of measure
struct simple : T
{
...
/**************************************************************************************************/
  ...
  BOOST_STATIC_ASSERT( (is_base_of<basic_tag, T >::value) );
/**************************************************************************************************/
...
#define PROTOX_SIMPLE(simple_name)                 \
  simple_name() {}                                 \
  simple_name(simple::value_type v) : simple(v) {}
#else
#define PROTOX_SIMPLE(simple_name)                                                                                        \
  simple_name() {}                                                              \
  typedef simple<simple_name::basic_type, simple_name::unit_type > simple_type; \
