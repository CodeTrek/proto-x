...
static void advance_time( double timestep, RTI::RTIambassador &rti_amb, fed_amb_base &fed_amb )
{
	// request the advance
...
static void enable_time_policy( RTI::RTIambassador &rti_amb, const fed_amb_base &fed_amb )
{
	////////////////////////////
