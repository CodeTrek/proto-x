...
#ifndef PROTOX_RPR_SPATIAL_RP_STRUCT_HPP
#define PROTOX_RPR_SPATIAL_RP_STRUCT_HPP
...
//      +-----------------+-----------------+----------------------------------------------+
                                                                               struct type : hla_13::complex_type < mpl::vector<  WorldLocation, IsFrozen, Padding, Orientation, VelocityVector, AngularVelocity > > {};}
//      +----------------------------------------------------------------------------------+----------------------+
