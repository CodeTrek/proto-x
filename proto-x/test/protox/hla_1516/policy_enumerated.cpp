...
#include "./test_days_of_week_enum.hpp"
  ...
  BOOST_AUTO_TEST_CASE( test_enum_equivalence_set )
  {
    ...
    // Decode the raw enumerator value representation as
    // a ColorEnum.
    ColorEnum red;
    ...
    // Verify that the decoded ColorEnum does not match any of the
    // legal ColorEnum enumerators.
    ...
    // Encode two different value representations for the
    // colorEnum_Blue enumerator.
    ...
    // Verify that the decoded representations are valid
    // ColorEnum_Blue enumerators.
    BOOST_CHECK( blue1 == blue2 );
