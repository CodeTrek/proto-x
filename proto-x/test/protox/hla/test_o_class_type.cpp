...
BOOST_AUTO_TEST_CASE(test_o_class_type_ctor ) {
    ...
    typedef o_class_type< som, q_name< Class_C, Class_A, Class_E > >::type class_type;
...
BOOST_AUTO_TEST_CASE(test_o_class_type_inheritance) {
    ...
    typedef o_class_type< som, q_name< Class_C >                   >::type  c_class_type;
    typedef o_class_type< som, q_name< Class_C, Class_A >          >::type ca_class_type;
    typedef o_class_type< som, q_name< Class_C, Class_C >          >::type cc_class_type;
    typedef o_class_type< som, q_name< Class_C, Class_A, Class_E > >::type cae_class_type;
...
BOOST_AUTO_TEST_CASE(test_o_class_type_publish_subset) {
    ...
    BOOST_CHECK_THROW(c2::publish(rti_amb, "A7.A2.A4"), RTI::AttributeNotDefined);
}
