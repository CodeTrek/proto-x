...
struct custom_codec_impl
{
  ...
  {
    typedef typename
      protox::dtl::compute_octet_boundary< T::size_in_bits >::type type;

    BOOST_STATIC_ASSERT(( type::value !=
      protox::dtl::UNKNOWN_OCTET_BOUNDARY::value ));
  };
  ...
  inline static void decode( T &v, const S &s, std::size_t &offset )
  {
    ...
    protox::hla_1516::HLAoctet::value_type *v_ptr
      = (protox::hla_1516::HLAoctet::value_type *)(&v.value);
