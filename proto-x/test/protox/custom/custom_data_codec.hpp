...
struct custom_codec_impl
{
  ...
  {
    BOOST_STATIC_ASSERT
      (( boost::mpl::sizeof_< protox::hla_1516::HLAoctet::value_type >::value == 1 ));

    const protox::hla_1516::HLAoctet::value_type
      *bytes = (const protox::hla_1516::HLAoctet::value_type *)(&obj.value);
  ...
  inline static void decode( T &v, const S &s, std::size_t &offset )
  {
    ...
    protox::hla_1516::HLAoctet::value_type
      *v_ptr = (protox::hla_1516::HLAoctet::value_type *)(&v.value);
...
template<>
struct codec_impl< test::custom::Test16BitTwosComplementUnsigned >
  : test::custom::custom_codec_impl
{};

template<>
struct codec_impl< test::custom::Test32BitTwosComplementUnsigned >
  : test::custom::custom_codec_impl
{};

template<>
struct codec_impl< test::custom::Test64BitTwosComplementUnsigned >
  : test::custom::custom_codec_impl
{};
