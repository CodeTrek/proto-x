...
/******************************************************************************/
  ...
  namespace t1
  {
    ...
    struct SimpleUnsigned16BE : simple< UnsignedInt16BE >
      { PROTOX_SIMPLE( SimpleUnsigned16BE ) }; 
  }
  ...
  BOOST_AUTO_TEST_CASE( test_encode_UnsignedInt16BE )
  {
    ...
    BOOST_CHECK(
      ntohs( *((SimpleUnsigned16BE *) sink.getDataBuffer()) ) == 23171 );
  }
...
/******************************************************************************/
  ...
  namespace t2
  {
    ...
    struct SimpleUnsigned32BE : simple< UnsignedInt32BE >
      { PROTOX_SIMPLE( SimpleUnsigned32BE ) }; 
  }
  ...
  BOOST_AUTO_TEST_CASE( test_encode_UnsignedInt32BE )
  {
    ...
    SimpleUnsigned32BE value
      = SYS_NTOHL( *((SimpleUnsigned32BE *) sink.getDataBuffer()) );
...
/******************************************************************************/
  ...
  namespace t3
  {
    ...
    struct SimpleUnsigned64BE : simple< UnsignedInt64BE >
      { PROTOX_SIMPLE( SimpleUnsigned64BE ) }; 
  }
  ...
  BOOST_AUTO_TEST_CASE( test_encode_UnsignedInt64BE )
  {
    ...
    SimpleUnsigned32BE lowBytes
      = SYS_NTOHL( *((SimpleUnsigned32BE *) (sink.getDataBuffer() + 4)) );

    SimpleUnsigned32BE highBytes
      = SYS_NTOHL( *((SimpleUnsigned32BE *) sink.getDataBuffer()) );
